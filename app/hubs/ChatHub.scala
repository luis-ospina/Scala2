...
class ChatHub extends Hub[ChatPage] {
  ...
  // Función para loguearnos al chat donde se le entra el usuario como parametro, 
  // no realiza ninguna confirmación a parte de no tener el nombre de Robot y por defecto
  // nos lleva a la sala Lobby
  ...
  // Función para crear una nueva sala y automaticamente llevarnos a ella
  ...
  // Función para envíar un mensaje al chat
